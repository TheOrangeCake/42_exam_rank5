...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/11/20 11:57:10 by hoannguy          #+#    #+#             */
/*   Updated: 2025/11/20 14:43:25 by hoannguy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int validate(t_map *map) {
	...
	for (int y = 0; y < map->height; y++) {
		for (int x = 0; x < map->width; x++) {
			if (map->map[y][x] != map->obstacle && map->map[y][x] != map->empty)
				return -1;
		}
	}
	return 0;
